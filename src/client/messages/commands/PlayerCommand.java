...
public class PlayerCommand {
    ...
    public static class Mystic extends OpenNPCCommand {
    ...
    public static class BuySun extends CommandExecute {

        public int execute(MapleClient c, String[] splitted) {
            if (c.getPlayer().getMeso() >= 1030000000) {
                c.getPlayer().gainMeso(-1030000000, true);
                MapleInventoryManipulator.addById(c, 4001165, (short) 1, c.getPlayer().getName());
                c.getPlayer().dropMessage(6, " You have lost 2 Billion mesos and have gained 1 Sunshine.");
                c.getPlayer().dropMessage(6, " You now have a total of  " + c.getPlayer().getItemQuantity(4001165, true) + " Sunshines.");
                c.getPlayer().dropMessage(-1, " You now have a total of  " + c.getPlayer().getItemQuantity(4001165, true) + " Sunshines.");
                return 1;
            } else {
                c.getPlayer().dropMessage(6, " You don't even have 1 billion mesos + 0,03% taxes. Total : 1030000000 Mesos.");
                return 0;
            }
        }
    }
    ...
    public static class Go extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            if (splitted.length != 2) {
                ...
                c.getPlayer().dropMessage(6, "========================================================================");
                c.getPlayer().dropMessage(6, "                ..::| MysticMS Goto Map Selections |::..                 ");
                c.getPlayer().dropMessage(6, "========================================================================");
                ...
                c.getPlayer().dropMessage(6, "| florina  | fly     | spa     | moon      | casino  | lionheart | futur");
                return 0;
            }
            maps.clear();
            return 0;
    ...
    public static class Help extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            c.getPlayer().dropMessage(5, "                MysticMS Commands");
            c.getPlayer().dropMessage(5, "========================================================");
            ...
            c.getPlayer().dropMessage(5, "@buysun [Buy Sunshines for 2.1billion Mesos ( Server Currency )");
            c.getPlayer().dropMessage(5, "@chalktalk <text> [Set at chalkboard with <text>]");
            c.getPlayer().dropMessage(5, "@go <map> [Type @go for <map> list]");
             ...
             */
            c.getPlayer().dropMessage(5, "@mystic [Main NPC/Universal Warper/JobAdvancment]");
            c.getPlayer().dropMessage(5, "@dcash [NX Item Dropper]");
            /*
             * if (!GameConstants.GMS) { c.getPlayer().dropMessage(5, "@pokedex
             * < Universal Information >"); c.getPlayer().dropMessage(5,
             * "@pokemon < Universal Monsters Information >");
             * c.getPlayer().dropMessage(5, "@challenge < playername, or
             * accept/decline or block/unblock >"); }
             */
    ...
    public static class TradeHelp extends TradeExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(-2, "[MysticMS System] : <@offerequip, @offeruse, @offersetup, @offeretc, @offercash> <quantity> <name of the item>");
            return 1;
        }
    }
        ...
        public int execute(MapleClient c, String[] splitted) {
            if (splitted.length < 3) {
                ...
                if (!c.getPlayer().getTrade().setItems(c, found, (byte) -1, quantity)) {
                    ...
                    c.getPlayer().getTrade().chatAuto("[MysticMS System] : " + c.getPlayer().getName() + " offered " + ii.getName(found.getItemId()) + " x " + quantity);
                }
            }
            return 1;
        }
