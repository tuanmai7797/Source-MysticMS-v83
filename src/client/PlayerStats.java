...
public class PlayerStats implements Serializable {
                ...
                for (int i : potentials) {
                    if (i > 0) {
                        ...
                        if (pot != null) {
                            ...
                            handlePotential(pot, chra, first_login, sData);
                        }
                    }
                }
            }
    ...
    public void handlePotential(StructPotentialItem pot, MapleCharacter chra, boolean first_login, Map<Skill, SkillEntry> hmm) {
        localstr += pot.incSTR;
        localdex += pot.incDEX;
        ...
        if (first_login && pot.skillID > 0) {
            hmm.put(SkillFactory.getSkill(getSkillByJob(pot.skillID, chra.getJob())), new SkillEntry((byte) 1, (byte) 0, -1));
        }
    }
