...
public class CWvsContext {
    ...
    public static class BuffPacket {
        ...
        public static byte[] giveForeignPirate(Map<MapleBuffStat, Integer> statups, int duration, int cid, int skillid) {
            final boolean infusion = skillid == 5121009 || skillid == 15111005 || (cid == -1 && skillid % 10000 == 8006);
            MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static byte[] getGachaponMega(final String name, final String message, final Item item, final byte rareness) {
        return getGachaponMega(name, message, item, rareness, false);
    }

    public static byte[] getGachaponMega(final String name, final String message, final Item item, final byte rareness, final boolean dragon) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static byte[] sendPyramidEnergy(final String type, final String amount) {
        return sendString(1, type, amount); // energy, massacre_hit, massacre_miss, massacre_cool, massacre_skill, PRaid_Team, balloon_Team, redTeam, blueTeam
    }
