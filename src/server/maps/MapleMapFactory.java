...
public class MapleMapFactory {
    ...
    private static AbstractLoadedMapleLife loadLife(int aInt, int aInt0, boolean b, int aInt1, int aInt2, int aInt3, int aInt4, int aInt5, int aInt6, String string, int aInt7) {
...
public static int loadCustomLife() {
        ...
        try {
            ...
            PreparedStatement ps = (PreparedStatement) con.prepareStatement("SELECT * FROM `wz_customlife`");
