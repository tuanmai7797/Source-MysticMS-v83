var Message = new Array(
    ...
    "1 billion mesos can be traded for Sunshine. from @MysticMS .",
    ...
    "Check out @MysticMS  to get to many town/monster maps!",
    ...
    "You can purchase your respective mounts at Monster Rider Shop accessed by @MysticMS .",
...
function start() {
    scheduleNew();
    em.broadcastYellowMsg("[MysticMS Tip] " + Message[Math.floor(Math.random() * Message.length)]);
}