...
function action(mode, type, selection) {
    ...
    status++;
    if (status == 0) {
        cm.sendSimple("Hello #h #! I'm the #r#eVoting Point NPC#n#k Of MysticMS. you have gain vote points by voting on our site,If you haven't voted in the recent 6 hours go vote now! you have #e#r" + cm.getPlayer().getVPoints() + "#n#k voting points! I can Exchange your points for Items you can't get anywhere! Watcha wating for? GO IN!\r\n\#b#L0#Trade for Common Items#l\r\n#L1#Trade for Special Items#l\r\n#L2#Trade for Royal Hair#r (35 Vote Points Needed For Each)#b#l\r\n#L3#Trade for Minigame Item\r\n#L4#Reset ALL AP \r\n\r\n #rDOES NOT reset HP or MP  #r (35 Vote points!) #k#l#k");
    } else if (status == 1) { 
        status += selection;
        var selStr;
        var it;
