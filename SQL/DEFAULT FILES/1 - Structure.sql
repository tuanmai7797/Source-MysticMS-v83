...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`odin_sea` /*!40100 DEFAULT CHARACTER SET latin1 */;

CREATE DATABASE /*!32313 IF NOT EXISTS*/`odin_gms` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `shopitems` (
  ...
  KEY `shopid` (`shopid`)
) ENGINE=MyISAM AUTO_INCREMENT=2446 DEFAULT CHARSET=latin1;
...
CREATE TABLE `shops` (
  ...
  PRIMARY KEY (`shopid`)
) ENGINE=MyISAM AUTO_INCREMENT=9595018 DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
